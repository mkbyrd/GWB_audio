...
AudioSynthWaveform       waveform1;      //xy=200,321
AudioSynthWaveformSineModulated sine_fm1;       //xy=262,419
AudioSynthNoisePink      pink1;          //xy=281,600
AudioSynthWaveformSine   sine1;          //xy=298,524
AudioMixer4              mixer1;         //xy=485,460
AudioMixer4              mixer2;         //xy=700,321
AudioEffectEnvelope      envelope1;      //xy=742,474
AudioOutputI2S           i2s1;           //xy=955,386
